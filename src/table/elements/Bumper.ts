...
export class Bumper {
  ...
  onHit(): void {
    ...
    // Tuned for ~80g ball: 0.04 N·s -> ~0.5 m/s outward velocity change
    // on top of the ball's incoming bounce. Snappy without launching the
    // ball off the playfield.
    const popStrength = 0.045;
